...
# sqlSave(ch1, dat=table_start_page,  varTypes=c(Date='datetime'), append=T, rownames=F)
# sqlSave(ch1, dat=table_goods_page,  varTypes=c(Date='datetime'), append=T, rownames=F)
# sqlSave(ch1, dat=table_cart_page,   varTypes=c(Date='datetime'), append=T, rownames=F)
# sqlSave(ch1, dat=table_pay_page,    varTypes=c(Date='datetime'), append=T, rownames=F)
# sqlSave(ch1, dat=table_success_pay, varTypes=c(Date='datetime'), append=T, rownames=F)
